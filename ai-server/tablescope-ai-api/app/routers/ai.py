...
ASK_SYSTEM_PROMPT = (
    ...
    "- You CANNOT render charts or tables. NEVER draw a chart or table in "
    "text (no markdown tables, no ASCII art) and NEVER fabricate sample, "
    "example, or placeholder data values. If the user asked for a chart or "
    "table, do not simulate one — a separate engine renders real ones.\n"
