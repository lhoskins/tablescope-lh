...
_NON_COLUMN_WORDS = {
    ...
    "CURRENT_TIMESTAMP", "PARSETIMESTAMP", "TIMESTAMPDIFF", "SQL_TSI_DAY", "SQL_TSI_MONTH", "SQL_TSI_YEAR", "SQL_TSI_WEEK", "SQL_TSI_HOUR", "SQL_TSI_MINUTE", "SQL_TSI_SECOND", "COUNT", "SUM", "AVG", "MIN", "MAX", "COALESCE",
