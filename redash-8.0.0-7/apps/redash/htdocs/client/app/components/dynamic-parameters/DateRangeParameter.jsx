...
const DYNAMIC_DATE_OPTIONS = [
  { name: 'Today', value: 'd_today', label: () => getDynamicDateRange('d_today').value()[0].format('MMMM') },
  { name: 'Yesterday', value: 'd_yesterday', label: () => getDynamicDateRange('d_yesterday').value()[0].format('MMMM') },
  { name: 'This week',
    value: 'd_this_week',
  ...
  { name: 'Last 14 days',
    ...
    label: () => getDynamicDateRange('d_last_14_days').value()[0].format('MMM D') + ' - Today' },
  { name: 'Last 30 days',
    value: 'd_last_30_days',
    label: () => getDynamicDateRange('d_last_30_days').value()[0].format('MMM D') + ' - Today' },
  { name: 'Last 60 days',
    value: 'd_last_60_days',
    label: () => getDynamicDateRange('d_last_60_days').value()[0].format('MMM D') + ' - Today' },
  { name: 'Last 90 days',
    value: 'd_last_90_days',
    label: () => getDynamicDateRange('d_last_90_days').value()[0].format('MMM D') + ' - Today' },
