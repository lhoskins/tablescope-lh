...
function QueryResource(
  ...
  QueryService.prototype.getQueryResult = function getQueryResult(maxAge) {
    // BUSINESS-CRITICAL FIX: Force fresh execution to prevent stale cached results
    // This ensures accuracy. To enable caching for specific queries, set query.enableCache = true
    if (!this.enableCache) {
      maxAge = 0;
    }
...
export function showQueryId(queryId) {
