...
def base_url(org):
    # Use configured HOST or fallback to default TableScope server
    host = settings.HOST if settings.HOST and settings.HOST != '0.0.0.0' else 'http://64.52.108.62:8080'
