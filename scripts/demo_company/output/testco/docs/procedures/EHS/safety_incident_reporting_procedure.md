...
**Owning Function:** EHS
**Document ID:** PRC-SAFETY-INCIDENT-REPORTING-PROCEDURE
**Effective Date:** 2026-01-01
**Review Frequency:** Annual

## 1. Purpose
Define the standard steps TestCo Demo Company follows for safety incident reporting
so the process is consistent, auditable, and repeatable across all sites.

## 2. Scope
Applies to the EHS function and any personnel participating in this
process at TestCo Demo Company.

## 3. Roles and Responsibilities
- **Process Owner (EHS)** — maintains the procedure and trains staff.
...
Tablescope project for EHS.

## 7. Related Documents
- Applicable company policies.
- Related datasets in the EHS project.

## Revision History
| Version | Date | Author | Summary |
| --- | --- | --- | --- |
| 1.0 | 2026-01-01 | EHS | Initial synthetic demo release. |
