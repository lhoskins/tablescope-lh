# Quarterly Business Review Procedure
...
**Owning Function:** Executive
**Document ID:** PRC-QUARTERLY-BUSINESS-REVIEW-PROCEDURE
**Effective Date:** 2026-01-01
**Review Frequency:** Annual

## 1. Purpose
Define the standard steps TestCo Demo Company follows for quarterly business review
so the process is consistent, auditable, and repeatable across all sites.

## 2. Scope
Applies to the Executive function and any personnel participating in this
process at TestCo Demo Company.

## 3. Roles and Responsibilities
- **Process Owner (Executive)** — maintains the procedure and trains staff.
...
Tablescope project for Executive.

## 7. Related Documents
- Applicable company policies.
- Related datasets in the Executive project.

## Revision History
| Version | Date | Author | Summary |
| --- | --- | --- | --- |
| 1.0 | 2026-01-01 | Executive | Initial synthetic demo release. |
