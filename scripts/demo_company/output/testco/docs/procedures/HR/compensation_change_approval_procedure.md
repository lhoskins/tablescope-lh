# Compensation Change Approval Procedure
...
**Owning Function:** HR
**Document ID:** PRC-COMPENSATION-CHANGE-APPROVAL-PROCEDURE
**Effective Date:** 2026-01-01
**Review Frequency:** Annual

## 1. Purpose
Define the standard steps TestCo Demo Company follows for compensation change approval
so the process is consistent, auditable, and repeatable across all sites.

## 2. Scope
Applies to the HR function and any personnel participating in this
process at TestCo Demo Company.

## 3. Roles and Responsibilities
- **Process Owner (HR)** — maintains the procedure and trains staff.
...
Tablescope project for HR.

## 7. Related Documents
- Applicable company policies.
- Related datasets in the HR project.

## Revision History
| Version | Date | Author | Summary |
| --- | --- | --- | --- |
| 1.0 | 2026-01-01 | HR | Initial synthetic demo release. |
