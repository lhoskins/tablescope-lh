...
**Owning Function:** IT
**Document ID:** PRC-VENDOR-SAAS-REVIEW-PROCEDURE
**Effective Date:** 2026-01-01
**Review Frequency:** Annual

## 1. Purpose
Define the standard steps TestCo Demo Company follows for vendor / saas review
so the process is consistent, auditable, and repeatable across all sites.

## 2. Scope
Applies to the IT function and any personnel participating in this
process at TestCo Demo Company.

## 3. Roles and Responsibilities
- **Process Owner (IT)** — maintains the procedure and trains staff.
...
Tablescope project for IT.

## 7. Related Documents
- Applicable company policies.
- Related datasets in the IT project.

## Revision History
| Version | Date | Author | Summary |
| --- | --- | --- | --- |
| 1.0 | 2026-01-01 | IT | Initial synthetic demo release. |
