# Claims / Disputes Escalation Procedure
...
**Owning Function:** Legal & Contracts
**Document ID:** PRC-CLAIMS-DISPUTES-ESCALATION-PROCEDURE
**Effective Date:** 2026-01-01
**Review Frequency:** Annual

## 1. Purpose
Define the standard steps TestCo Demo Company follows for claims / disputes escalation
so the process is consistent, auditable, and repeatable across all sites.

## 2. Scope
Applies to the Legal & Contracts function and any personnel participating in this
process at TestCo Demo Company.

## 3. Roles and Responsibilities
- **Process Owner (Legal & Contracts)** — maintains the procedure and trains staff.
...
Tablescope project for Legal & Contracts.

## 7. Related Documents
- Applicable company policies.
- Related datasets in the Legal & Contracts project.

## Revision History
| Version | Date | Author | Summary |
| --- | --- | --- | --- |
| 1.0 | 2026-01-01 | Legal & Contracts | Initial synthetic demo release. |
