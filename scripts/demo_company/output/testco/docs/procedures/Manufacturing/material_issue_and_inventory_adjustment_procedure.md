# Material Issue and Inventory Adjustment Procedure
...
**Owning Function:** Manufacturing
**Document ID:** PRC-MATERIAL-ISSUE-AND-INVENTORY-ADJUSTMENT-PROCEDURE
**Effective Date:** 2026-01-01
**Review Frequency:** Annual

## 1. Purpose
Define the standard steps TestCo Demo Company follows for material issue and inventory adjustment
so the process is consistent, auditable, and repeatable across all sites.

## 2. Scope
Applies to the Manufacturing function and any personnel participating in this
process at TestCo Demo Company.

## 3. Roles and Responsibilities
- **Process Owner (Manufacturing)** — maintains the procedure and trains staff.
...
Tablescope project for Manufacturing.

## 7. Related Documents
- Applicable company policies.
- Related datasets in the Manufacturing project.

## Revision History
| Version | Date | Author | Summary |
| --- | --- | --- | --- |
| 1.0 | 2026-01-01 | Manufacturing | Initial synthetic demo release. |
