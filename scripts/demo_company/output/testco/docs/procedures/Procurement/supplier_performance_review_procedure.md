# Supplier Performance Review Procedure
...
**Owning Function:** Procurement
**Document ID:** PRC-SUPPLIER-PERFORMANCE-REVIEW-PROCEDURE
**Effective Date:** 2026-01-01
**Review Frequency:** Annual

## 1. Purpose
Define the standard steps TestCo Demo Company follows for supplier performance review
so the process is consistent, auditable, and repeatable across all sites.

## 2. Scope
Applies to the Procurement function and any personnel participating in this
process at TestCo Demo Company.

## 3. Roles and Responsibilities
- **Process Owner (Procurement)** — maintains the procedure and trains staff.
...
Tablescope project for Procurement.

## 7. Related Documents
- Applicable company policies.
- Related datasets in the Procurement project.

## Revision History
| Version | Date | Author | Summary |
| --- | --- | --- | --- |
| 1.0 | 2026-01-01 | Procurement | Initial synthetic demo release. |
