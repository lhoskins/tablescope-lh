# Quote and Proposal Approval Procedure
...
**Document ID:** PRC-QUOTE-AND-PROPOSAL-APPROVAL-PROCEDURE
**Effective Date:** 2026-01-01
**Review Frequency:** Annual

## 1. Purpose
Define the standard steps TestCo Demo Company follows for quote and proposal approval
so the process is consistent, auditable, and repeatable across all sites.

## 2. Scope
Applies to the Sales function and any personnel participating in this
process at TestCo Demo Company.

## 3. Roles and Responsibilities
- **Process Owner (Sales)** — maintains the procedure and trains staff.
...
Tablescope project for Sales.

## 7. Related Documents
- Applicable company policies.
- Related datasets in the Sales project.

## Revision History
| Version | Date | Author | Summary |
| --- | --- | --- | --- |
| 1.0 | 2026-01-01 | Sales | Initial synthetic demo release. |
