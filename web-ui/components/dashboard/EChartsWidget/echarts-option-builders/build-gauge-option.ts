...
export function buildGaugeOption(
  ...
  const option: any = {
    ...
    series: [{
      ...
      axisLabel: { show: !tiny, distance: 12, color: colorsForChart.text, fontSize: 10, formatter: (v: number) => formatNumber(v, opts.yAxisFormat, undefined, opts.currencySymbol) },
      ...
      detail: {
        ...
        formatter: (v: number) => formatNumber(v, opts.yAxisFormat, undefined, opts.currencySymbol),
        offsetCenter: [0, "-15%"],
      },
