...
import { getDefaultOptions, getChartDefinition } from "@/lib/visualizations/chartRegistry";import { SubtypeDef } from "./subtype-def";


export type ChartTypeDef = { type: WidgetType; label: string; icon: string; subtypes: SubtypeDef[] };