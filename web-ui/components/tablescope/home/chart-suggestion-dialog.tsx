...
const FALLBACK_CANDIDATES: VizCandidate[] = [
  ...
  },
  {
    decision: {
      ...
      yField: "value",
      valueFormat: "number",
      reason: "Cumulative or volume view over ordered labels.",
      confidence: 0.55,
    },
    score: 0.55,
    supported: true,
  },
  {
    decision: {
      ...
      yField: "value",
      valueFormat: "number",
      reason: "Part-to-whole share breakdown.",
      confidence: 0.5,
    },
    score: 0.5,
    supported: true,
  },
  {
    decision: {
      ...
      yField: "value",
      valueFormat: "number",
      reason: "Multi-metric comparison of a few entities.",
      confidence: 0.45,
    },
    score: 0.45,
    supported: true,
  },
  {
    decision: {
      ...
      yField: "value",
      valueFormat: "number",
      reason: "Stage-like or ranked categories.",
      confidence: 0.42,
    },
    score: 0.42,
    supported: true,
  },
  {
    decision: {
      ...
      yField: "value",
      valueFormat: "number",
      reason: "Relative size of categories around a center.",
      confidence: 0.4,
    },
    score: 0.4,
    supported: true,
  },
  {
    decision: {
      ...
      yField: "value",
      valueFormat: "number",
      reason: "Hierarchical part-to-whole by category.",
      confidence: 0.38,
    },
    score: 0.38,
    supported: true,
