...
import {
  ...
  IconCalendar,
  IconTrash,
} from "@tabler/icons-react";import { riskImpactTone } from "./risk-impact-tone";
import { riskImpactLabel } from "./risk-impact-label";



export function RiskCell({ impact }: { impact: string | null }) {
