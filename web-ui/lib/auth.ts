...
/**
 * Request a password-reset email for the tenant user.
 *
 * The reset link is generated by the backend using the Supabase GoTrue admin
 * API and delivered through Tablescope's own transactional email channel,
 * because the Supabase project does not have a custom email provider configured.
 */
